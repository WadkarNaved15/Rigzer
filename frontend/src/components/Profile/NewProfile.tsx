            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="flex items-center gap-5 flex-wrap">
                ...
                <button
                  ...
                  className="bg-white hover:bg-gray-200 text-[#191919] px-4 py-2 rounded-full text-xs font-black uppercase tracking-widest transition-all hover:shadow-[0_0_15px_rgba(255,255,255,0.3)] active:scale-95">
                  Edit Profile
                </button>
        ...
        <div className="w-full max-w-6xl mx-auto p-4">
          ...
          <div className="flex flex-col md:flex-row justify-between items-stretch gap-6">
            ...
            <div className="flex-1 pt-2">
              <div className="relative overflow-hidden rounded-3xl bg-[#191919] border border-white/10 shadow-2xl h-full min-h-[400px] flex flex-col">
                ...
                <div className="p-8 flex-grow">
                  {/* This area will expand to fill the space, keeping the card tall */}
            ...
            <div className="w-full md:w-40 shrink-0 pt-2">
              <div className="bg-[#191919] p-6 rounded-3xl border border-white/10 text-white shadow-2xl flex flex-col items-center h-full">
                <h3 className="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-500 mb-8">Socials</h3>
